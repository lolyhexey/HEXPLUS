...
[[ $(screen -list| grep -c 'bot_teste') == '0' ]] && {
    ...
    echo ""
    echo -ne "\n\033[1;32mกรอก TOKEN\033[1;37m: "
    read token
    [[ -z "$token" ]] && {
        echo -e "\033[1;31m[ผิดพลาด]\033[1;33m เปิดใช้งานบอทไม่สำเร็จ: ไม่ได้กรอก TOKEN — รันคำสั่งอีกครั้งแล้วกรอก TOKEN ของบอท Telegram\033[0m"
        exit 1
    }
    clear
    echo "-----------ตัวอย่าง-----------"
